            ...
            <div className="max-w-7xl mx-auto mb-20 overflow-hidden">
              ...
              <div className="relative overflow-hidden mb-3">
                <div className="infinite-scroll">
                  ...
                  <div className="scroll-item rounded-xl overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-sm">
                    <img src="/brands/athletic-shoes.jpg" alt="Athletic shoes" className="w-full h-full object-cover" />
                  </div>
                  <div className="scroll-item rounded-xl overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-sm">
                    <img src="/brands/jacket.jpg" alt="Leather jacket" className="w-full h-full object-cover" />
                  </div>
                  <div className="scroll-item rounded-xl overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-sm">
                    <img src="/brands/watch.jpg" alt="Luxury watch" className="w-full h-full object-cover" />
                  </div>
